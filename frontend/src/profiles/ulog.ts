...
const ulog: FormatProfile = {
  ...
  positionSources: [
    { key: 'global', label: 'Global', kind: 'global', altIsMSL: true, lat: { type: 'vehicle_global_position', field: 'lat' }, lng: { type: 'vehicle_global_position', field: 'lon' }, alt: { type: 'vehicle_global_position', field: 'alt' } },
    { key: 'gps', label: 'GPS', kind: 'global', altIsMSL: true, lat: { type: 'sensor_gps', field: 'latitude_deg' }, lng: { type: 'sensor_gps', field: 'longitude_deg' }, alt: { type: 'sensor_gps', field: 'altitude_msl_m' } },
