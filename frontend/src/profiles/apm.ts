...
const apm: FormatProfile = {
  ...
  positionSources: [
    { key: 'pos', label: 'POS', kind: 'global', lat: { type: 'POS', field: 'Lat' }, lng: { type: 'POS', field: 'Lng' }, alt: { type: 'POS', field: 'RelHomeAlt' } },
    { key: 'ahr2', label: 'AHR2', kind: 'global', altIsMSL: true, lat: { type: 'AHR2', field: 'Lat' }, lng: { type: 'AHR2', field: 'Lng' }, alt: { type: 'AHR2', field: 'Alt' } },
    { key: 'gps', label: 'GPS', kind: 'global', altIsMSL: true, lat: { type: 'GPS1', field: 'Lat' }, lng: { type: 'GPS1', field: 'Lng' }, alt: { type: 'GPS', field: 'Alt' } },
  ],
