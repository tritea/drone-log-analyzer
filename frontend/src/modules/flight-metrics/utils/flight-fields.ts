...
export function defaultAltField(): string {
  ...
  return keyOf(match?.alt) || 'POS.RelHomeAlt';
}
...
export function makeDefaultMetricItems(): MetricItem[] {
  return [
    { id: 'builtin-mode', name: '飞行模式', kind: 'field', fields: [MODE_FIELD_KEY], render: 'number', min: 0, max: 1, minInput: '0', maxInput: '1', orient: 'horizontal', builtin: 'mode', unit: '', origUnit: '', unitMul: 1 },
    { id: 'builtin-speed', name: '水平速度', kind: 'field', fields: [SPEED_FIELD_KEY], render: 'number', min: 0, max: 30, minInput: '0', maxInput: '30', orient: 'horizontal', builtin: '', unit: 'm/s', origUnit: 'm/s', unitMul: 1 },
    { id: 'builtin-vspeed', name: '垂直速度', kind: 'field', fields: [VSPEED_FIELD_KEY], render: 'number', min: -10, max: 10, minInput: '-10', maxInput: '10', orient: 'horizontal', builtin: '', unit: 'm/s', origUnit: 'm/s', unitMul: 1 },
    { id: 'builtin-alt', name: '高度', kind: 'field', fields: [defaultAltField()], render: 'number', min: 0, max: 200, minInput: '0', maxInput: '200', orient: 'horizontal', builtin: '', unit: 'm', origUnit: 'm', unitMul: 1 },
    { id: 'builtin-baro', name: '气压高度', kind: 'field', fields: [defaultBaroField()], render: 'number', min: 0, max: 200, minInput: '0', maxInput: '200', orient: 'horizontal', builtin: '', unit: 'm', origUnit: 'm', unitMul: 1 },
    { id: 'builtin-volt', name: '电压', kind: 'field', fields: [VOLT_FIELD_KEY], render: 'number', min: 0, max: 25, minInput: '0', maxInput: '25', orient: 'horizontal', builtin: '', unit: 'V', origUnit: 'V', unitMul: 1 },
    { id: 'builtin-motor', name: '电机输出', kind: 'group', fields: [MOTOR_FIELD_KEY], render: 'bar', min: 1000, max: 2000, minInput: '1000', maxInput: '2000', orient: 'vertical', builtin: 'motor', unit: 'PWM', origUnit: 'PWM', unitMul: 1 },
  ];
}
