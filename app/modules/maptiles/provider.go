...
// hideable is implemented by providers serving non-imagery tiles (e.g.
// terrain DEM). They stay routable and cached like any provider but are
// excluded from basemap pickers via ProviderInfo.Hidden.
type hideable interface{ Hidden() bool }
